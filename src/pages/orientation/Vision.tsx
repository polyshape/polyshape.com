...
export default function Vision() {
  return (
    <div className="prose">
      ...
      <p>
        PolyShape envisions learning systems for healthcare built on mathematical foundations. These systems are modular and can be composed into larger systems. They reason under uncertainty, integrate diverse biomedical data and their interrelations, and support decisions that affect human health. Among their capabilities is the design of multi-agent learning systems that advance health intelligence.
      </p>
    </div>
  );
}
